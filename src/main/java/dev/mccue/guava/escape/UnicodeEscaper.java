...
public abstract class UnicodeEscaper extends Escaper {
   ...
   * method will throw {@code IllegalArgumentException}. You should ensure your input is valid <a
   ...
   *
   * <p>See {@code dev.mccue.guava.net.PercentEscaper} for an example.
   *
   ...
   *
   * <p>This method is not reentrant and may only be invoked by the top level {@code
   ...
   *
   * <p>Unlike {@code Character#codePointAt(CharSequence, int)} or {@code String#codePointAt(int)}
   * this method will never fail silently when encountering an invalid surrogate pair.
   *
   * <p>The behaviour of this method is as follows:
   *
   * <ol>
   *   <li>If {@code index >= end}, {@code IndexOutOfBoundsException} is thrown.
   ...
   *         <li>If the next character was not a low surrogate value, then {@code
   *             IllegalArgumentException} is thrown.
   *       </ol>
   *   <li>If the first character was a low surrogate value, {@code IllegalArgumentException} is
   *       thrown.
   * </ol>
   *
